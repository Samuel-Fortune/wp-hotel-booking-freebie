...
<main id="primary" class="site-main">
  ...
  <section class="bread-crumb">
    <div class="site-wrapper">
      <ul class="breadcrumb">
        ...
        <li><a href="#">Grand Hilton Hotel</a></li>
      </ul>
    </div>
  </section>
  ...
  <section class="hotel-wrapper">
    <div class="site-wrapper">
      ...
      <!---->
        <div class="beach">
          <img src="wp-content/themes/hotel-booking-freebie/asset/images/bg.jpeg" alt="">
        </div>
        <!---->
        ...
        <div class="trip-advisor-wrapper" id="trip-advisor-wrapper">
          ...
          <div class="wrapp1">
            <div class="wrapp-image">
              <img src="wp-content/themes/hotel-booking-freebie/asset/images/Rectangle1.png" alt="">
              <span>
                <p>Flash Offer</p>
              </span>
            </div>
  ...
  <section class="guest-review-section" id="guest-review-section">
    <div class="site-wrapper">
