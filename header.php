...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'hotel-booking-freebie');?></a>
	...
	<header id="masthead" class="site-header">
		...
		<div class="nav-main" id="nav-main">
			<div class="site-wrapper">
			<div class="best-tour-plan" id="best-tour-plan">
				<!--First div-->
				<div class="site-branding logo-search" id="logo-search">
				    ...
				    <form class="flex" action="" method="get">
					 ...
					 <button class="search-button">
					   <img src="<?php echo get_template_directory_uri() ?>/asset/icons/FindButton.png" alt="">
					 </button>
				    </form>
			    </div><!-- .site-branding -->
				...
				<span class="profile">
					<img src="<?php echo get_template_directory_uri() ?>/asset/images/Ellipse1.png" alt="">
					<p>Nathan</p>
					<button class="button">
					<img src="<?php echo get_template_directory_uri() ?>/asset/images/Vector(Stroke).png" alt="">
					</button>
				</span>
